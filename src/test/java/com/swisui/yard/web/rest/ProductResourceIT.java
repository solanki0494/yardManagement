...
class ProductResourceIT {
    ...
    private static final Double DEFAULT_DEFAULT_GST = 1D;
    private static final Double UPDATED_DEFAULT_GST = 2D;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).defaultPrice(DEFAULT_DEFAULT_PRICE).defaultGST(DEFAULT_DEFAULT_GST);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).defaultPrice(UPDATED_DEFAULT_PRICE).defaultGST(UPDATED_DEFAULT_GST);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getDefaultGST()).isEqualTo(DEFAULT_DEFAULT_GST);
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].defaultGST").value(hasItem(DEFAULT_DEFAULT_GST.doubleValue())));
    }
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.defaultGST").value(DEFAULT_DEFAULT_GST.doubleValue()));
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).defaultPrice(UPDATED_DEFAULT_PRICE).defaultGST(UPDATED_DEFAULT_GST);
        ...
        assertThat(testProduct.getDefaultGST()).isEqualTo(UPDATED_DEFAULT_GST);
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).defaultPrice(UPDATED_DEFAULT_PRICE).defaultGST(UPDATED_DEFAULT_GST);
