...
import { EntityArrayResponseType, LoadingProductService } from '../service/loading-product.service';
import { LoadingProductDeleteDialogComponent } from '../delete/loading-product-delete-dialog.component';
import { SortService } from 'app/shared/sort/sort.service';

@Component({
  selector: 'jhi-loading-product',
...
export class LoadingProductComponent implements OnInit {
  ...
  delete(loadingProduct: ILoadingProduct): void {
    const modalRef = this.modalService.open(LoadingProductDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.loadingProduct = loadingProduct;
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.loadingProductService.query(1, queryObject).pipe(tap(() => (this.isLoading = false)));
  }
